...
Description: object-relational SQL database
 ...
 .
 [pg_controldata]
 returns information initialized during initdb, such as the catalog version
 and server locale.
 .
 [pg_ctl]
 ...
 .
 [pltcl_delmod]
 is a support script used to delete a module from a PL/Tcl table. The command
 requires the Pgtcl package to be installed also.
 .
 [pltcl_listmod]
 is a support script used to list the modules in a PL/Tcl table. The command
 requires the Pgtcl package to be installed also.
 .
 [pltcl_loadmod]
 is a support script used to load a module into a PL/Tcl table. The command
 requires the Pgtcl package to be installed also.
 .
 [postgres]
